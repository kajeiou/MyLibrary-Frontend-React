...
export default function UserEdit(props) {
    ...
    const { register, handleSubmit, formState: { errors }} = useForm({
        defaultValues: {
            ...
            isAdmin: props.userSelected.isAdmin,
        }
    });
    ...
    return(
        <div className="UserEdit">
            ...
            <button id="editUser" className="btn w-100 btn-block btn-secondary " onClick={openModal}>
                    ...
                    <div className="card-body">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="form-group row">
                                <label htmlFor="email" className="col col-form-label">Adresse email</label>
                                <div className="col-8 text-center">
                                    <input name="email" type="email" className="form-control" id="email" aria-describedby="emailHelp" placeholder="Entrez une adresse email" {...register("email", {required:'Adresse email obligatoire'})}  />
