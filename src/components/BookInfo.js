...
export default function BookInfo(props) {
    ...
    return(
        <div className="BookInfo">
            <button id="viewBook" className="btn w-100 btn-block btn-primary" onClick={openModal}>
            ...
            <Modal isOpen={modalIsOpen} onRequestClose={closeModal} style={customStyles} contentLabel="Example Modal" shouldCloseOnOverlayClick={false}>
                ...
                ISBN : {props.book.isbn} <br/>Stock : {props.book.stock} <br/>Prix : {props.book.price}<br/><br/>
                <button className="btn w-100 btn-block btn-danger"onClick={closeModal}>
